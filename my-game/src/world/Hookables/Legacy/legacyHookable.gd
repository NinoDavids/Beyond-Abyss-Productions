...
## A function that gets called as soon as the [LegacyHookable] [member is_hooked] AND the [Player] [kbd]scroll wheel down[/kbd].
func reel_in() -> void:
	pass
...
## Removes the [member bobber] from the [LegacyHookable].
